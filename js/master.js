$(document).ready(function(){
  ...
  vehicleArray[7] = new Vehicle(
    ...
    '.25',
    '3,299',
    'Includes $3,000 XC90 conquest. Conquest applies to current audi,bmw,m/b,acura,lexus infiniti,cadillac,lincoln,jeep lessees',
