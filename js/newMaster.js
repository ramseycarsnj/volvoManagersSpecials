$(document).ready(function(){
  ...
  vehicleArray[4] = new Vehicle(
    ...
    vehicleArray[5] = new Vehicle(
      ...
      'Power ABS',
      'Power',
      'Windows, Locks, Seats, Mirrors, BLIS',
      'Climate Control, Moonroof',
      'H2433466',
      'VOH0347',
      '36',
      '50870',
      ...
      '0.25',
      '3579',
      'vehicleImages/VOH0347.jpg',
      'https://www.volvocarsramsey.com/new/Volvo/2017-Volvo-S60-ramsey-nj-17a6ad650a0e0ae8779b2f8baa1cd18c.htm');
  ...
  vehicleArray[6] = new Vehicle(
    ...
    vehicleArray[7] = new Vehicle(
      ...
      'Power ABS',
      'Power',
      'Windows, Locks, Seats, Mirrors, VISION,CLIMATE,CONVENIENCE PKG',
      'Air Conditioning, Roof Rack, Moonroof',
      'H1151111',
      'VOH0350',
      '50',
      '60165',
      ...
      'https://www.volvocarsramsey.com/new/Volvo/2017-Volvo-XC90-ramsey-nj-17a6ad140a0e0ae8779b2f8b29d5524a.htm');

      vehicleArray[8] = new Vehicle(
        'New',
        '2017',
        'VOLVO',
        'XC90 HYBRID T8 AWD INSCRIPTION',
        'WHITE',
        '7 Passenger',
        '4 Cylinder',
        'Auto w/OD',
        'Power ABS',
        'Power',
        'Windows, Locks, Seats, Mirrors, VISION,CLIMATE,HUD,CONVENIENCE',
        'Air Conditioning, Climate Control, Leather Interior, 3rd Row Seat, Moonroof',
        'H1114908',
        'VOH0207',
        '7500',
        '76345',
        ...
        'https://www.volvocarsramsey.com/new/Volvo/2017-Volvo-XC90+Hybrid-ramsey-nj-de2c03a40a0e0ae85a0d6baeb70fac8c.htm');
